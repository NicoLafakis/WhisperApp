...
and save work runs off the UI thread. The on-screen waveform responds to microphone
level while recording. After release it stays visible with a static wave,
elapsed time, partial transcript preview (for GPT
